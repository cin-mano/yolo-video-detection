...
std::vector<std::string> load_class_list()
{
    ...
    std::ifstream ifs("/home/hstpl_lap_131/this/openCv/Yolov5_Video_Object_Detection/Models/classes.txt");
    std::string line;
...
void load_net(cv::dnn::Net &net, bool is_cuda)
{
    ...
    auto result = cv::dnn::readNet("/home/hstpl_lap_131/this/openCv/Yolov5_Video_Object_Detection/Models/yolov5s.onnx");
    if (is_cuda)
    {
        // std::cout << "Using CUDA\n";
...
int main(int argc, char **argv)
{
    ...
    try
    {
        ...
        int targetWidth = 600; // Adjust the desired width
        ...
        while (true)
        {
            ...
            for (int i = 0; i < detections; ++i)
            {
                ...
                cv::putText(frame, class_list[classId].c_str(), cv::Point(box.x, box.y - 5), cv::FONT_HERSHEY_SIMPLEX, 4, cv::Scalar(0, 0, 0), 6);
